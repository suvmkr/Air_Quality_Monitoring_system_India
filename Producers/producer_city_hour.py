...
def stream_data(file_path, interval, data_type):
    ...
    df = df[df[time_col].dt.year == 2020]
    ...
    print(f"Starting {data_type} producer for year 2020...")
    ...
    for timestamp, group in grouped:
        for _, row in group.iterrows():
            ...
            producer.produce('aqiproject', value=json.dumps(data))
        producer.flush()
